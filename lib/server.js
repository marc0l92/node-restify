...
//   2.1 _runPre
//     2.2. _afterPre (runs after pre handlers are finisehd, triggers use)
//       3.1 _runUse
//         3.2. _afterUse (runs after use handlers are finised, triggers route)
//          4.1 _runRoute
//            4.2 _afterRoute (runs after route handler finished)
 ...
 * @fires Request,Response#request
 */
Server.prototype._runUse = function _runUse(req, res) {
    var self = this;
