 ...
 * @memberof Chain
 * @instance
 * @param {Function|Chain} handler - handler or Chain instance
...
Chain.prototype.add = function add(handler) {
    ...
    if (typeof handler.run === 'function') {
        var chain = handler;
        handler = function nestedChainHandler(req, res, next) {
            chain.run(req, res, next);
        };
    }
 ...
 *
 * @private
 * @param {Function} handler - rr function
